...
<head>
<meta charset="UTF-8">
<title>스마투스코리아 ::: 전자상거래(인터넷사이버몰) 표준약관</title>
<style type="text/css">
...
<div class="align_right">
	<select name="terms_lang" onchange="window.open(value,'_self');">
		<option value="termsOfServiceKo.do">한국어</option>
		<option value="termsOfServiceEn.do">영어</option>
	</select>
</div>
<br/>
<br/>
<div class="align_right">
	<img id="ct_logo" alt="공정거래위원회_로고" src="/imgs/document/ct_logo_01_ko.png">
</div>
<br/>
...
<b>제1조(목적)</b><br/>
<br/>
&nbsp;&nbsp;이 약관은 ㈜스마투스코리아 회사(전자상거래 사업자)가 운영하는 스마투스 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.<br/>
&nbsp;&nbsp;앞에서 이하 “몰”로 명시한다고 해서... 그 뒤의 “사이버 몰”들은 모두 “몰”로 명시했습니다.<br/>
다른 용어들도 모두 이렇게 처리했습니다.<br/>
<br/>
...
<br/>
&nbsp;&nbsp;① “몰”이란 ㈜스마투스코리아 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.<br/>
<br/>
...
<br/>
&nbsp;&nbsp;① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 스마투스 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.<br/>
<br/>
...
&nbsp;&nbsp;&nbsp;&nbsp;1. 가입신청자가 이 약관 제7조 제3항에 의하여 이전에 회원자격을 상실한 적이 있는 경우, 다만 제7조제3항에 의한 회원자격 상실 후 3년이 경과한 자로서 “몰”의 회원 재가입 승낙을 얻은 경우에는 예외로 한다.<br/>
